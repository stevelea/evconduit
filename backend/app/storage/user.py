...
def get_abrp_pull_stats(user_id: str) -> dict | None:
    ...
    try:
        result = supabase.table("users") \
            .select("abrp_pull_user_token, abrp_pull_session_token, abrp_pull_api_key, abrp_pull_vehicle_ids, abrp_pull_enabled, abrp_pull_success_count, abrp_pull_fail_count, abrp_pull_last_pull_at, abrp_pull_last_error") \
            .eq("id", user_id) \
            .maybe_single() \
            .execute()
